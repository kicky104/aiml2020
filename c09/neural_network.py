...
def predict_with_SVM(ax, train_data):
    '''
    使用 MLPClassifier绘制预测结果
    :param ax: Axes 实例，用于绘制图形
    :param train_data: 训练数据集
    ...
    print(accuracy_score(y_hat, train_y))  # 查看在训练集上的评价预测精度
